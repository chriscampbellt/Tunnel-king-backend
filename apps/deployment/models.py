...
class ServerInstance(BaseModel):
    ...
    status = models.CharField(
        max_length=50,
        choices=[("active", "Active"), ("standby", "Standby"), ("terminated", "Terminated")],
    )
...
class ScalingPolicy(BaseModel):
    ...
    scale_down_time = models.PositiveIntegerField(help_text="Minutes of inactivity before scaling down.")